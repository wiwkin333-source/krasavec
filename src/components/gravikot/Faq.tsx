...
const items: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Перед оплатой вы бесплатно получаете макет и утверждаете его. После согласования с вами происходит оплата и следующим шагом изготовление изделия. Если ошибка допущена по нашей вине (брак, не тот рисунок) — переделаем за свой счёт. Мы пришлём фото готовой работы перед отправкой. Повредили при доставке? — Мы подготовим для вас всю доказательную базу (фото упаковки, документы) и напишем претензию, чтобы вы быстро вернули деньги за страховку груза",
  },
  {
