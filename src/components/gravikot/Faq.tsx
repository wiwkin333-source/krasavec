...
const items: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Работаем только по предоплате. Если сделали строго по утвержденному макету — возврат невозможен! Если ошиблись мы (цвет, расположение, брак) — переделаем за свой счет. Отправляем по России Почтой, Озон, Яндекс, СДЭК за ваш счет. Возможен самовывоз в г. Самаре. Если происходит повреждение транспортной компанией — составляем акт и поможем с претензией.",
  },
  {
