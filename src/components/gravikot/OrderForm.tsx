  ...
  return createPortal(
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-3 sm:p-4 bg-background/85 backdrop-blur-xl overflow-x-clip"
      ...
      <div className="relative neon-border rounded-3xl max-w-lg w-full p-6 sm:p-8 md:p-10"
        ...
        <h2 className="luxe-title text-center text-xl sm:text-2xl -translate-x-[5%] md:translate-x-0">
          <span className="whitespace-nowrap md:block">Свяжитесь</span>{' '}<span className="whitespace-nowrap md:block">с нами</span>
        </h2>
