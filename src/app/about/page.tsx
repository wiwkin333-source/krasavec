...
export const metadata = {
  ...
  description: "ГРАВИКОТ — самозанятый Курипта Дмитрий Викторович. Светящаяся гравировка на стекле с 2026 года. ИНН 501721586348.",
  alternates: {
    ...
    <main className="min-h-screen bg-background text-foreground">
      <div className="max-w-3xl mx-auto px-4 py-12 md:py-20">
        ...
        <article className="space-y-8 text-sky-100/90 leading-relaxed">
          {/* Кто мы */}
          <section>
            <h2 className="font-display font-bold text-xl text-foreground mb-3">ГРАВИКОТ — мастерская светящейся гравировки</h2>
            <p>
              ГРАВИКОТ — это авторская мастерская, которая создаёт уникальные сувениры и подарки со светящейся гравировкой на стекле. Каждое изделие изготавливается вручную с применением лазерных технологий, что обеспечивает высочайшую точность переноса изображения и яркое свечение в темноте.
            </p>
            <p className="mt-3">
              Мы работаем с фотографиями, логотипами, надписями и любыми изображениями, которые вы хотите видеть на кружке, бокале или другом стеклянном изделии. Результат — индивидуальный подарок, который светится в темноте и оставляет незабываемое впечатление.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Сайт gravikot.ru является официальной витриной товаров и услуг мастерской ГРАВИКОТ. Все представленные на сайте изделия изготавливаются нами лично — от приёмки макета до отправки готового заказа. Мы не являемся посредниками и не перепродаём чужую продукцию.
            </p>
            <p className="mt-3">
          ...
          <section>
            ...
            >
              ...
              <div>
                <div className="font-display font-bold text-foreground group-hover:text-emerald-300 transition">Плачу налоги</div>
                <div className="text-sky-100/60 text-sm mt-0.5">Работаю официально, чеки отправляю в электронном виде</div>
              </div>
            </a>
          </section>
