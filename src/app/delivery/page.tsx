        ...
        <article className="space-y-8 text-sky-100/90 leading-relaxed">
            ...
            <div className="glass rounded-2xl p-5 space-y-4 text-sm">
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <div className="text-sky-100/70 mt-1">
                    Если ошибка допущена по нашей вине — неправильно подобрали цвет, нарушили расположение элементов или допустили производственный брак — мы переделаем изделие за свой счёт. Качество для нас в приоритете.
                  </div>
                </div>
              </div>
            </div>
          ...
          <section>
            ...
            <div className="mt-4">
              <Image
                src="/assets/map.webp"
                alt="Карта самовывоза ГРАВИКОТ — г. Самара, ул. Советской Армии, 23"
                width={800}
                height={320}
          ...
          <section>
            ...
            <p>
              К сожалению, транспортные компании не всегда бережно обращаются с посылками. Если изделие повреждено при доставке — не расстраивайтесь. Мы подготовим для вас всю доказательную базу (фото упаковки, документы) и напишем претензию, чтобы вы быстро вернули деньги за страховку груза.
            </p>
            <p className="mt-3">
