...
export const metadata: Metadata = {
  ...
  description:
    "Каталог коллекций светящейся гравировки от ГРАВИКОТ. Кружки, чашки, бокалы, фужеры и стаканы с уникальной глоу-арт гравировкой по вашему фото. Цены от 2 399 ₽. Доставка по России.",
  keywords: "кружка, чашка, бокал, фужер, стакан, светящаяся гравировка, глоу-арт, гравировка по фото",
  alternates: {
  ...
  openGraph: {
    title: "Каталог — светящаяся гравировка на стекле | ГРАВИКОТ",
    description:
      "Коллекции светящейся гравировки на стекле. Кружки, чашки, бокалы, фужеры, стаканы с глоу-арт гравировкой. Цены от 2 399 ₽.",
