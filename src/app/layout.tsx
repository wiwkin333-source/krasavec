...
export const metadata: Metadata = {
  ...
  keywords: "кружка, чашка, бокал, фужер, стакан, гравировка, светящаяся гравировка, лазерная гравировка, кружка с гравировкой, чашка с гравировкой, фужер с гравировкой, стакан с гравировкой, глоу-арт, Самара",
  alternates: {
  ...
  openGraph: {
    title: "ГРАВИКОТ - Кружка со светящейся гравировкой по фото",
    description: "Кружки, чашки, бокалы, фужеры, стаканы со светящейся гравировкой по вашему фото. Уникальные сувениры с подсветкой. Доставка по России.",
    type: "website",
    locale: "ru_RU",
    siteName: "ГРАВИКОТ",
    images: [
      {
        ...
        width: 1200,
        height: 1200,
        alt: "ГРАВИКОТ — кружка, чашка, бокал, фужер, стакан со светящейся гравировкой по фото",
      },
    ],
  },
  twitter: {
