...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      ...
      { url: "/favicon.ico?v=3", sizes: "16x16 24x24 32x32 48x48 64x64" },
      // PNG — explicit sizes for browsers that prefer them
      { url: "/favicon-16x16.png?v=3", sizes: "16x16", type: "image/png" },
      { url: "/favicon-24x24.png?v=3", sizes: "24x24", type: "image/png" },
      ...
      { url: "/favicon-196x196.png?v=3", sizes: "196x196", type: "image/png" },
    ],
    apple: [
      // All iOS device sizes
      { url: "/apple-touch-icon-120x120.png?v=3", sizes: "120x120" },
      { url: "/apple-touch-icon-152x152.png?v=3", sizes: "152x152" },
      { url: "/apple-touch-icon-167x167.png?v=3", sizes: "167x167" },
      { url: "/apple-touch-icon.png?v=3", sizes: "180x180" },
      { url: "/apple-touch-icon-precomposed.png?v=3", sizes: "180x180" },
    ],
    shortcut: [
      { url: "/favicon.ico?v=3" },
    ],
  ...
  other: {
    ...
    "msapplication-square70x70logo": "/mstile-70x70.png?v=3",
    "msapplication-square150x150logo": "/mstile-150x150.png?v=3",
    "msapplication-square310x310logo": "/mstile-310x310.png?v=3",
    "msapplication-wide310x150logo": "/mstile-310x150.png?v=3",
  ...
  return (
    <html lang="ru" suppressHydrationWarning>
      <head>
        ...
        <link rel="mask-icon" href="/safari-pinned-tab.svg?v=3" color="#050510" />
        {/* Apple startup images for PWA — explicit link for iOS */}
        <link rel="apple-touch-startup-image" href="/apple-touch-icon.png?v=3" />
      </head>
